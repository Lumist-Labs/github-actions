...
| [`claude-issue-autowork.yml`](.github/workflows/claude-issue-autowork.yml) | Beacon-dispatched: score one issue in a target repo; if small and nothing protected, implement it and open a **draft** PR, otherwise offer it to an admin or hand it to a human. Needs a GitHub App — see [`docs/runbooks/issue-autowork.md`](docs/runbooks/issue-autowork.md). | `v2` |
